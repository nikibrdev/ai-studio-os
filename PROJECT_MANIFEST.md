...
| **Version** | v0.8 Dashboard — **завершён** (2026-07-23); v0.9 API — завершён ([порядок реализации](engineering/decisions/2026-07-22-api-before-dashboard-build-order.md)) ([ROADMAP.md](ROADMAP.md)) |
| **Status** | **Architecture Frozen** (2026-07-19) |
| **Current Epic** | Нет открытого эпика — [EPIC-009 Dashboard](docs/roadmap/EPIC-009-dashboard.md) закрыт (2026-07-23): `apps/dashboard` — Next.js, read-only наблюдение за проектами/задачами через `apps/api`, TASK-072…078 |
