...
Остальные шаги пока выполняет человек через `apps/api`: приведение задачи к Definition of Ready (роль PM), вердикт ревью, подтверждение QA. Их автоматизация — следующие эпики декомпозиции v1.0 (роли PM/QA, механизм подтверждения человеком).
