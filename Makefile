...
.PHONY: help build vet fmt fmt-check lint test md-lint docs-check verify metrics install-hooks
...
help: ## Показать список целей
	...
	@echo "  make install-hooks - установить git-хуки (pre-commit, pre-push)"
...
md-lint:
	@if command -v npx >/dev/null 2>&1; then npx --yes markdownlint-cli2 "**/*.md" "#**/node_modules/**" "#**/.next/**" "#engineering/metrics/**"; else echo "md-lint: SKIPPED (npx не найден); в CI проверка обязательна"; fi
